...
```docker
docker run --rm -p 80:80 --name etrs89-new -v `pwd`/ETRS89andRDNAP:/srv/data -e DEBUG=0 -e MIN_PROCS=1 -e MAX_PROCS=3 -e MAX_LOAD_PER_PROC=4 -e IDLE_TIMEOUT=20 -e MAPSERVER_CONFIG_FILE=/srv/data/etrs89.conf -e MS_MAPFILE=/srv/data/etrs89.map pdok/mapserver:8.0.0-lighttpd
```
