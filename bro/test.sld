...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:se="http://www.opengis.net/se" version="1.1.0">
  <NamedLayer>
    <se:Name>geomorphological_area_collection</se:Name>
    <UserStyle>
      <se:Name>BRO-GMM-Geomorfologischekaart_V2024-01_1 geomorphological_area</se:Name>
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
          ...
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>landform_subgroup_code</ogc:PropertyName>
        ...
        <se:Rule>
          ...
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#fe0000</se:SvgParameter>
            </se:Fill>
          </se:PolygonSymbolizer>
        </se:Rule>
        <se:Rule>
        ...
        <se:Rule>
          <se:Name>Pingoruïnes</se:Name>
          <se:Description>
            <se:Title>Pingoruïnes</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>landform_subgroup_code</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>Periglaciale laagte</se:Name>
          <se:Description>
            <se:Title>Periglaciale laagte</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>landform_subgroup_code</ogc:PropertyName>
              <ogc:Literal>N22</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#8dd7fe</se:SvgParameter>
            </se:Fill>
            <se:Stroke>
        ...
        <se:Rule>
          <se:Name>Uitblazingskom</se:Name>
          <se:Description>
            <se:Title>Uitblazingskom</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>landform_subgroup_code</ogc:PropertyName>
